class LineItem < ApplicationRecord
    ...
    def total_price
      if cart.u == true && cart.vendor_type == false
      ...
      elsif  cart.u == true && cart.vendor_type == true
        productdetails1_ids = cart.productdetails1.map(&:to_i)
        ...
        if productdetails1_ids.include?(productdetail_id)
          ...
          if cart.amt_type =="percentage"
            ...
            result = (quantity * productdetail.price - item_price * cart.dis_amt / cart.total_item_discount)
            return  result < 0 ? 0 : result
      ...
      def discount_price
       ...
       return  item_price * cart.dis_amt / cart.total_item_discount 
